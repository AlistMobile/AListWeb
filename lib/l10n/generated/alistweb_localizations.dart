...
import 'alistweb_localizations_en.dart';
import 'alistweb_localizations_zh.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of AListWebLocalizations
/// returned by `AListWebLocalizations.of(context)`.
///
/// Applications need to include `AListWebLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'generated/alistweb_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: AListWebLocalizations.localizationsDelegates,
...
/// be consistent with the languages listed in the AListWebLocalizations.supportedLocales
/// property.
abstract class AListWebLocalizations {
  AListWebLocalizations(String locale)
    : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static AListWebLocalizations of(BuildContext context) {
    return Localizations.of<AListWebLocalizations>(
      context,
      AListWebLocalizations,
    )!;
  }

  static const LocalizationsDelegate<AListWebLocalizations> delegate =
      _AListWebLocalizationsDelegate();
...
class _AListWebLocalizationsDelegate
    extends LocalizationsDelegate<AListWebLocalizations> {
  const _AListWebLocalizationsDelegate();

  @override
  Future<AListWebLocalizations> load(Locale locale) {
    return SynchronousFuture<AListWebLocalizations>(
      lookupAListWebLocalizations(locale),
    );
  }
  ...
  @override
  bool shouldReload(_AListWebLocalizationsDelegate old) => false;
}

AListWebLocalizations lookupAListWebLocalizations(Locale locale) {
    ...
    case 'zh':
      {
        switch (locale.scriptCode) {
          case 'Hans':
            return AListWebLocalizationsZhHans();
          case 'Hant':
            return AListWebLocalizationsZhHant();
        }
        break;
      }
  }
    ...
    case 'zh':
      {
        switch (locale.countryCode) {
          case 'CN':
            return AListWebLocalizationsZhCn();
          case 'TW':
            return AListWebLocalizationsZhTw();
        }
        break;
      }
  }
  ...
  switch (locale.languageCode) {
    case 'en':
      return AListWebLocalizationsEn();
    case 'zh':
      return AListWebLocalizationsZh();
  }

  throw FlutterError(
    'AListWebLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
